...
DOI_PATTERN_VERSION_0 = regex_compile(r"doi[\s\.\:]{0,2}(10\.\d{4}[\d\:\.\-\/a-z]+)(?:[\s\n\"<]|$)")
DOI_PATTERN_VERSION_1 = regex_compile(r"(10\.\d{4}[\d\:\.\-\/a-z]+)(?:[\s\n\"<]|$)")
DOI_PATTERN_VERSION_2 = regex_compile(r"(10\.\d{4}[\:\.\-\/a-z]+[\:\.\-\d]+)(?:[\s\na-z\"<]|$)")
DOI_PATTERN_VERSION_3 = regex_compile(r"https?://[ -~]*doi[ -~]*/(10\.\d{4,9}/[-._;()/:a-z0-9]+)(?:[\s\n\"<]|$)")
DOI_PATTERN_VERSION_4 = regex_compile(r"^(10\.\d{4,9}/[-._;()/:a-z0-9]+)$")
ARXIV_PATTERN_AFTER_2007 = regex_compile(r"^(\d{4}\.\d+)(?:v\d+)?$")
ARXIV_PATTERN_VERSION_0 = regex_compile(r"arxiv[\s]*\:[\s]*(\d{4}\.\d+)(?:v\d+)?(?:[\s\n\"<]|$)")
